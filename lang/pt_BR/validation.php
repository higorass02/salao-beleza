...
return [
    ...
    'attributes' => [
        ...
        'active'               => 'ativo',
        'notes'                => 'observações',
        'birth_day'            => 'dia de aniversário',
        'birth_month'          => 'mês de aniversário',
        'price'                => 'preço',
        'duration_minutes'     => 'duração',
        'description'          => 'descrição',
        'include_house_fee'    => 'taxa da casa',
        'starts_at'            => 'horário de início',
        'ends_at'              => 'horário de término',
        'client_id'            => 'cliente',
        'employee_id'          => 'funcionário',
        'service_id'           => 'serviço',
        'paid_to'              => 'para quem foi pago',
        'performed_at'         => 'horário',
        'client_name'          => 'nome do cliente',
        'service_name'         => 'nome do serviço',
        'service_value'        => 'valor do serviço',
        'business_hours_start' => 'horário de abertura',
        'business_hours_end'   => 'horário de fechamento',
        'house_fee_rate'       => 'taxa de serviço da casa',
